...
public class AppController {
    ...
    public String viewProductDetails(@PathVariable("id") Long id, Model model) {
        ...
        // Check if AI analysis is already cached in DB
        if (product.getAiGeneratedPros() == null || product.getAiGeneratedPros().trim().isEmpty()) {
            ...
            // Save the newly generated analysis to DB to save future API credits
